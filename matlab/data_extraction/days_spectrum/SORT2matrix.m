...
filenames = strcat(day, timestamps);
target_path = fullfile(config.sys_config.SORT_ascii_path, day);

[R, ANG] = get_station_angle_radi(HF_station_coord, target_coord);
...
for ii = 1 : length(filenames)
    ...
    fname_sort_path = fullfile(sort_file_path, strcat(filenames(ii), '.SORT'));
